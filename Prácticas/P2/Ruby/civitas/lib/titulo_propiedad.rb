...
module Civitas
  class TituloPropiedad
    ...
    def cancelar_hipoteca(jugador)
      /salida = false
      if(@hipotcado == true && es_este_el_propietario(jugador))
        if(@propietario.paga(get_importe_cancelar_hipoteca()) == true)
          @hipotecado = false
          salida = true
        end
      end
    ...
    def hipotecar(jugador)
      ...
      if @hipotecado == false && es_este_el_propietario(jugador)
        if @propietario.recibe(get_importe_cancelar_hipoteca()) == true
          @hipotecado = true
          salida = true
        end
      end
    ...
    def tramitar_alquiler(jugador)
      if(tiene_propietario() == true && !es_este_el_propietario(jugador))
