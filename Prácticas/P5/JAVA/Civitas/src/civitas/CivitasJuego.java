...
public class CivitasJuego {
  ...
  public boolean construirCasa(int ip){
    ...
    private void inicializarMazoSorpresas(Tablero tablero){
        ...
        mazo.alMazo(new SorpresaIrACasilla(tablero,10,"Desplazate hacia la casilla indicada"));
        mazo.alMazo(new SorpresaIrACasilla(tablero,16,"Desplazate hacia la casilla indicada"));
        mazo.alMazo(new SorpresaIrACasilla(tablero,tablero.getCarcel(),"A la carcel"));
